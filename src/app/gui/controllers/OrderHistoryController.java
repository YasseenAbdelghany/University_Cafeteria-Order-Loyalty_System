...
public class OrderHistoryController {
    ...
    public void initialize() {
        logger.info("Initializing OrderHistoryController");
    ...
    private void handleBack() {
        ...
        if (currentStudent == null) {
            logger.warning("Student data not available, navigating to main menu");
        ...
        try {
            ...
            logger.severe("Error navigating back to dashboard: " + e.getMessage());
            AlertHelper.showError("Navigation Error", "Failed to return to dashboard: " + e.getMessage());
        }
    }
}
