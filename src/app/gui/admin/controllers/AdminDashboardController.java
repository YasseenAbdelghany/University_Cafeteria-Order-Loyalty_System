...
/**
 * Controller for the admin dashboard screen in the Administrative Application.
 * Provides integrated access to manager management and system reports.
 */
public class AdminDashboardController {
     ...
     * Called by AdminNavigationService when navigating to this screen with admin data.
     * 
    ...
    private void handleViewReports() {
        ...
        AdminNavigationService.navigateToWithData("reports", currentAdmin);
    }
     ...
     * Logs out the admin and returns to the unified login screen.
     */
    @FXML
